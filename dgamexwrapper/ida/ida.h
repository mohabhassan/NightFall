...
typedef struct Entry_Eventptr_EventDef_s {
	Event*					key;
	EventDef_s				value;
	//int					index;//not used in bt
	struct Entry_Eventptr_EventDef_s			*next;
} Entry_Eventptr_EventDef_t;
typedef struct {
	Entry_t				**table;
	unsigned int		tableLength;
